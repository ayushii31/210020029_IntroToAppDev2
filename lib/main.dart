            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: ["+", "-"]
                    ...
                    .toList(),
                decoration: InputDecoration(labelText: "Enter your Category"),
              ),
              TextField(
                onChanged: (text) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromARGB(
          255, 11, 216, 216), // Background color set to light pink
      body: Center(
        child: Column(
...
class WidgetListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Colors.pink[50], // Background color set to light pink
